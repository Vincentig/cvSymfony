...
class ExperienceController extends Controller
{
     ...
     *
     * @Route("/", name="admin_experience_create")
     * @Method("POST")
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_experience_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Experience $entity)
    {
        $form = $this->createForm(new ExperienceType(), $entity, array(
            'action' => $this->generateUrl('admin_experience_create'),
            'method' => 'POST',
        ));
     ...
     *
     * @Route("/new", name="admin_experience_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_experience_show")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="admin_experience_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
    ...
    {
        $form = $this->createForm(new ExperienceType(), $entity, array(
            'action' => $this->generateUrl('admin_experience_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_experience_update")
     * @Method("PUT")
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_experience_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}", name="admin_experience_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_experience_delete', array('id' => $id)))
            ->setMethod('DELETE')
